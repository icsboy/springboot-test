...
class ListComponent extends Component {
    ...
    getDocuments = () => {
        ...
        approvalApi.getCreatorDocuments(creatorId)
            .then((response) => {
    ...
    delete = id => {
        const creatorId = this.props.currentUserId;
        approvalApi.deleteDocument(id, creatorId)
            .then((response) => {
                this.reloadData();
            });
    };
    ...
    edit = document => {
        this.props.openEditForm(document);
    };
        ...
        return documents.map((document, index) => (
            <tr key={index}>
                ...
                { document.status === "request" &&
                    ...
                    <td><button onClick={() => this.delete(document.id)}>삭제</button></td>
                    </>
                }
            </tr>
        ));
